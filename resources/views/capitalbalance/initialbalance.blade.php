...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="col-lg-9">
                <div class="p-2">
                    <form class="user" method="POST" action="{{ route('capitalbalance.saveInitialBalance') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 mb-3 mb-sm-0">
                                <input type="number" class="form-control " name="saldo" id="saldo"
                                    value="{{ old('interest') }}" placeholder="saldo">
                            </div>
                            ...
                            <div class="col-sm-2 mb-3 mb-sm-0">
                                <input type="number" class="form-control " name="quota_number" id="quota_number"
                                    value="{{ old('quota_number') }}" placeholder="N° cuotas">
                            </div>
                            <div class="col-sm-4">
