...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="col-lg-7">
                <div class="p-2">
                    <form class="user" method="POST" action="{{ route('cliente.savecobrador') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control " name="user" id="user"
                                value="{{ old('user') }}" placeholder="Nombre del cobrador" disabled>
...
<div class="modal fade tableCustomer" id="cobradorModal" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>{{ $user->name }}</td>
                                <td>
                                    <button class="btn btn-success agregarCobrador " type="button" id="btnUser"
                                        data-id="{{ $user->id }}">Agregar</button>
                                </td>
                            </tr>
                        @endforeach
