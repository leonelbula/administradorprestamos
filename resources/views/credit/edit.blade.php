                        ...
                        <div class="form-group row">
                            <div class="col-sm-8 mb-3 mb-sm-0">
                                <input type="text" class="form-control " name="fullname" id="fullname"
                                    value="{{ $credit->customer->fullname }}" placeholder="Nombre Cliente" disabled>
                                <input type="hidden" name="id" id="id" value="{{ $credit->customer_id }}">
                            </div>
                            <div class="col-sm-4 mb-3 mb-sm-0">
                                <input type="date" class="form-control " name="date" id="date"
                                    value="{{ $credit->date }}" placeholder="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="number" class="form-control " name="amount" id="amount"
                                    value="{{ $credit->amount }}" placeholder="Valor Prestamo">
                            </div>
                            <div class="col-sm-6">
                                <input type="text" class="form-control " name="total" id="total"
                                    value="{{ $credit->balance }}" placeholder="Valor a Pagar">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-4 mb-3 mb-sm-0">
                                <input type="number" class="form-control " name="interest" id="interest"
                                    value="{{ credit->interest }}" placeholder="Interes">
                            </div>
                            <div class="col-sm-4 mb-3 mb-sm-0">
                                <input type="phone" class="form-control " name="quota_number" id="quota_number"
                                    value="{{ $credit->quota_number }}" placeholder="Numero dias">
                            </div>
                            <div class="col-sm-4">
                                <input type="number" class="form-control " name="quota" id="quota"
                                    value="{{ $credit->quota }}" placeholder="">
                            </div>
                        </div>
